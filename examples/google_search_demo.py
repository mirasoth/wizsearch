...
async def demo_headless_search():
    """Demonstrate Google search in headless mode (default)."""
...
async def demo_headed_search():
    """Demonstrate Google search with visible browser window (for debugging)."""
    ...
    try:
        ...
        search = GoogleSearch(config=GoogleSearchConfig(headless=False))
